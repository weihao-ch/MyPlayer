...
Parser::Parser(AVFormatContext *ctx, MediaInfo *info, AVCodecContext *videoDecCtx, AVCodecContext *audioDecCtx)
...
int Parser::openCodecContext(AVCodecContext **decCtx, enum AVMediaType type)
{
    int rc = 0;
    int streamIdx = -1;
    AVStream *st = nullptr;
